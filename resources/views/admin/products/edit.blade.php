...
<div class="card">
    <div class="card-header">
        ...
        <p style="font-size: 12px; color: #94a3b8; margin-top: 5px;">Update product information</p>
    </div>
        ...
        <div style="padding: 24px;">
            ...
            <div style="margin-bottom: 30px; padding-bottom: 30px; border-bottom: 1px solid rgba(148, 163, 184, 0.1);">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    <div class="form-group">
                        ...
                        <input type="text" id="name" name="name" required value="{{ $product->name }}" style="width: 100%; padding: 10px 12px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                    </div>

                    <div class="form-group">
                        <label for="slug" style="font-size: 12px; text-transform: uppercase; color: #94a3b8; margin-bottom: 8px; display: block;">Slug *</label>
                        <input type="text" id="slug" name="slug" required value="{{ $product->slug }}" style="width: 100%; padding: 10px 12px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                    </div>

                    <div class="form-group">
                        <label for="sku" style="font-size: 12px; text-transform: uppercase; color: #94a3b8; margin-bottom: 8px; display: block;">SKU *</label>
                        <input type="text" id="sku" name="sku" required value="{{ $product->sku }}" style="width: 100%; padding: 10px 12px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                    </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px;">
                    <div class="form-group">
                        ...
                        <div style="display: flex; align-items: center;">
                            ...
                            <input type="number" id="price" name="price" step="0.01" required value="{{ $product->price }}" style="width: 100%; padding: 10px 12px 10px 28px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div style="display: flex; align-items: center;">
                            <span style="position: absolute; padding-left: 12px; color: #94a3b8;">$</span>
                            <input type="number" id="cost_price" name="cost_price" step="0.01" required value="{{ $product->cost_price }}" style="width: 100%; padding: 10px 12px 10px 28px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="stock" name="stock" required value="{{ $product->stock }}" style="width: 100%; padding: 10px 12px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                    </div>
                </div>
            </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                    ...
                    <div class="form-group" style="display: flex; align-items: flex-end;">
                        <label style="display: flex; align-items: center; gap: 8px; cursor: pointer; color: #e2e8f0;">
                            <input type="checkbox" id="is_featured" name="is_featured" value="1" @if($product->is_featured) checked @endif style="width: 18px; height: 18px; cursor: pointer;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <div class="form-group" style="margin-bottom: 20px;">
                    ...
                    <input type="url" id="image_url" name="image_url" value="{{ $product->image_url }}" style="width: 100%; padding: 10px 12px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0;">
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea id="description" name="description" rows="5" style="width: 100%; padding: 10px 12px; background: rgba(15, 23, 42, 0.5); border: 1px solid rgba(148, 163, 184, 0.2); border-radius: 6px; color: #e2e8f0; font-family: inherit;">{{ $product->description }}</textarea>
                </div>
            </div>
        </div>
